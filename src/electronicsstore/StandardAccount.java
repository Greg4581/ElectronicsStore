        ...
        extends Account         //Super Class
{
    ...
    ArrayList<StoreObject> cart=new ArrayList<>();
    ArrayList<StoreObject> history=new ArrayList<>();
    ...
    public StandardAccount(String sFirstName, String sLastName, char cMiddleInitial,
            char cGender, String sPassword, String sEmail, int iPermissions,
            String sPayAccount)
    {
        super(sFirstName, sLastName, cMiddleInitial, cGender, sPassword, sEmail, iPermissions);
        this.setPayPal(sPayAccount);
    }
    
    
    //Mutators------------------------------------------------------------------
    public final void setPayPal(String sPayAccount)
